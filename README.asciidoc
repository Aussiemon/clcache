...
CLCACHE_CL::
    ...
    path.
CLCACHE_LOG::
    If this variable is set, a bit of diagnostic information is printed to
    show cache operations.
CLCACHE_LOG_VERBOSE::
    If this variable is set, a lot of diagnostic information is printed to
     help with debugging cache problems.
CLCACHE_DISABLE::
